...
# python manage.py runserver --settings=ae86forum.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-#8myc-+2&=%$v+-i4*s83$%qmfe!qay$wjr2euwmr1zj1jnct8")
